...
2. **Update Firmware**:
   ...
   - ![Firmware Update](https://example.com/firmware-update-image)  
...
3. **Connect Devices**:
   ...
   - ![Device Connection](https://example.com/device-connection-image)  
...
4. **Apply the Mod**:
   ...
   - ![Applying the Mod](https://example.com/apply-mod-image)  
...
5. **Verify Installation**:
   ...
   - ![Verification](https://example.com/verification-image)  
...
- ![Configuration Settings](https://example.com/configuration-settings-image)  
...
- ![Troubleshooting](https://example.com/troubleshooting-image)  
